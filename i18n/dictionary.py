translations_dict = {
    "zh_HANS": {
        ...
        ("*", "Required Python Packages (所需 Python 依赖库):"): "所需 Python 依赖库:",
        ("*", "Download & Mirror Configuration (下载源配置):"): "下载源配置:",
        ("*", "Python Environment Details (Python 环境信息):"): "Python 环境信息:",
        ("*", "Last Installation Output Log (最新安装日志):"): "最新安装日志:",
