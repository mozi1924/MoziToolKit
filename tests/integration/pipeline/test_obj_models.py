...
class TestOBJModels(unittest.TestCase):
    ...
    def test_firefly_bush_identifier_and_tint_exemption(self):
        ...
        from MoziToolKit.utils.materials.specialized import is_firefly_bush, is_firefly_bush_tint_exempt
    ...
    def test_firefly_bush_geometry_sanitization(self):
        """Verify that sanitize_firefly_bush_elements removes overlapping emissive cross elements."""
        from MoziToolKit.utils.materials.specialized import sanitize_firefly_bush_elements
    ...
    def test_firefly_bush_texture_synthesis_and_pack_stack(self):
