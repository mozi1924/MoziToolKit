...
class TestFluidLiveSync(unittest.TestCase):
    ...
    def test_mineways_slanted_side_face_uv_mapping(self):
        ...
        layers = {
            ...
            "timing": bm.faces.layers.float_vector.new("mtk_anim_timing"),
            "frame_size": bm.faces.layers.float_vector.new("mtk_anim_frame_size"),
    ...
    def test_fluid_culling(self):
        ...
        layers_sub = {
            ...
            "timing": bm_sub.faces.layers.float_vector.new("mtk_anim_timing"),
            "frame_size": bm_sub.faces.layers.float_vector.new("mtk_anim_frame_size"),
