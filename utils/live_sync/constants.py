...
MTK_COLORMAP_UV: Final = "mtk_colormap_uv"
...
HANDSHAKE_INFO_HEADER_FORMAT: Final = "<IIIH"
HANDSHAKE_INFO_HEADER_SIZE: Final = 14
...
MANIFEST_HEADER_FORMAT: Final = "<II"
MANIFEST_HEADER_SIZE: Final = 8
