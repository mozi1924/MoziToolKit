...
class MOZI_AddonPreferences(bpy.types.AddonPreferences):
    ...
    biome_preset: EnumProperty(
        ...
        items=[
            ('BADLANDS', "Badlands", "Temperature: 2.0, Downfall: 0.0"),
            ('BAMBOO_JUNGLE', "Bamboo Jungle", "Temperature: 0.95, Downfall: 0.9"),
            ('BASALT_DELTAS', "Basalt Deltas", "Temperature: 2.0, Downfall: 0.0"),
            ('BEACH', "Beach", "Temperature: 0.8, Downfall: 0.4"),
            ('BIRCH_FOREST', "Birch Forest", "Temperature: 0.6, Downfall: 0.6"),
            ('CHERRY_GROVE', "Cherry Grove", "Temperature: 0.5, Downfall: 0.8"),
            ('COLD_OCEAN', "Cold Ocean", "Temperature: 0.5, Downfall: 0.5"),
            ('CRIMSON_FOREST', "Crimson Forest", "Temperature: 2.0, Downfall: 0.0"),
            ('DARK_FOREST', "Dark Forest", "Temperature: 0.7, Downfall: 0.8"),
            ('DEEP_COLD_OCEAN', "Deep Cold Ocean", "Temperature: 0.5, Downfall: 0.5"),
            ('DEEP_DARK', "Deep Dark", "Temperature: 0.8, Downfall: 0.4"),
            ('DEEP_FROZEN_OCEAN', "Deep Frozen Ocean", "Temperature: 0.5, Downfall: 0.5"),
            ('DEEP_LUKEWARM_OCEAN', "Deep Lukewarm Ocean", "Temperature: 0.5, Downfall: 0.5"),
            ('DEEP_OCEAN', "Deep Ocean", "Temperature: 0.5, Downfall: 0.5"),
            ('DESERT', "Desert", "Temperature: 2.0, Downfall: 0.0"),
            ('DRIPSTONE_CAVES', "Dripstone Caves", "Temperature: 0.8, Downfall: 0.4"),
            ('END_BARRENS', "End Barrens", "Temperature: 0.5, Downfall: 0.5"),
            ('END_HIGHLANDS', "End Highlands", "Temperature: 0.5, Downfall: 0.5"),
            ('END_MIDLANDS', "End Midlands", "Temperature: 0.5, Downfall: 0.5"),
            ('ERODED_BADLANDS', "Eroded Badlands", "Temperature: 2.0, Downfall: 0.0"),
            ('FLOWER_FOREST', "Flower Forest", "Temperature: 0.7, Downfall: 0.8"),
            ('FOREST', "Forest", "Temperature: 0.7, Downfall: 0.8"),
            ('FROZEN_OCEAN', "Frozen Ocean", "Temperature: 0.0, Downfall: 0.5"),
            ('FROZEN_PEAKS', "Frozen Peaks", "Temperature: -0.7, Downfall: 0.9"),
            ('FROZEN_RIVER', "Frozen River", "Temperature: 0.0, Downfall: 0.5"),
            ('GROVE', "Grove", "Temperature: -0.2, Downfall: 0.8"),
            ('ICE_SPIKES', "Ice Spikes", "Temperature: 0.0, Downfall: 0.5"),
            ('JAGGED_PEAKS', "Jagged Peaks", "Temperature: -0.7, Downfall: 0.9"),
            ('JUNGLE', "Jungle", "Temperature: 0.95, Downfall: 0.9"),
            ('LUKEWARM_OCEAN', "Lukewarm Ocean", "Temperature: 0.5, Downfall: 0.5"),
            ('LUSH_CAVES', "Lush Caves", "Temperature: 0.5, Downfall: 0.5"),
            ('MANGROVE_SWAMP', "Mangrove Swamp", "Temperature: 0.8, Downfall: 0.9"),
            ('MEADOW', "Meadow", "Temperature: 0.5, Downfall: 0.8"),
            ('MUSHROOM_FIELDS', "Mushroom Fields", "Temperature: 0.9, Downfall: 1.0"),
            ('NETHER_WASTES', "Nether Wastes", "Temperature: 2.0, Downfall: 0.0"),
            ('OCEAN', "Ocean", "Temperature: 0.5, Downfall: 0.5"),
            ('OLD_GROWTH_BIRCH_FOREST', "Old Growth Birch Forest", "Temperature: 0.6, Downfall: 0.6"),
            ('OLD_GROWTH_PINE_TAIGA', "Old Growth Pine Taiga", "Temperature: 0.3, Downfall: 0.8"),
            ('OLD_GROWTH_SPRUCE_TAIGA', "Old Growth Spruce Taiga", "Temperature: 0.25, Downfall: 0.8"),
            ('PALE_GARDEN', "Pale Garden", "Temperature: 0.7, Downfall: 0.8"),
            ('PLAINS', "Plains", "Temperature: 0.8, Downfall: 0.4"),
            ('RIVER', "River", "Temperature: 0.5, Downfall: 0.5"),
            ('SAVANNA', "Savanna", "Temperature: 2.0, Downfall: 0.0"),
            ('SAVANNA_PLATEAU', "Savanna Plateau", "Temperature: 2.0, Downfall: 0.0"),
            ('SMALL_END_ISLANDS', "Small End Islands", "Temperature: 0.5, Downfall: 0.5"),
            ('SNOWY_BEACH', "Snowy Beach", "Temperature: 0.05, Downfall: 0.3"),
            ('SNOWY_PLAINS', "Snowy Plains", "Temperature: 0.0, Downfall: 0.5"),
            ('SNOWY_SLOPES', "Snowy Slopes", "Temperature: -0.3, Downfall: 0.9"),
            ('SNOWY_TAIGA', "Snowy Taiga", "Temperature: -0.5, Downfall: 0.4"),
            ('SOUL_SAND_VALLEY', "Soul Sand Valley", "Temperature: 2.0, Downfall: 0.0"),
            ('SPARSE_JUNGLE', "Sparse Jungle", "Temperature: 0.95, Downfall: 0.8"),
            ('STONY_PEAKS', "Stony Peaks", "Temperature: 1.0, Downfall: 0.3"),
            ('STONY_SHORE', "Stony Shore", "Temperature: 0.2, Downfall: 0.3"),
            ('SULFUR_CAVES', "Sulfur Caves", "Temperature: 0.8, Downfall: 0.4"),
            ('SUNFLOWER_PLAINS', "Sunflower Plains", "Temperature: 0.8, Downfall: 0.4"),
            ('SWAMP', "Swamp", "Temperature: 0.8, Downfall: 0.9"),
            ('TAIGA', "Taiga", "Temperature: 0.25, Downfall: 0.8"),
            ('THE_END', "The End", "Temperature: 0.5, Downfall: 0.5"),
            ('THE_VOID', "The Void", "Temperature: 0.5, Downfall: 0.5"),
            ('WARM_OCEAN', "Warm Ocean", "Temperature: 0.5, Downfall: 0.5"),
            ('WARPED_FOREST', "Warped Forest", "Temperature: 2.0, Downfall: 0.0"),
            ('WINDSWEPT_FOREST', "Windswept Forest", "Temperature: 0.2, Downfall: 0.3"),
            ('WINDSWEPT_GRAVELLY_HILLS', "Windswept Gravelly Hills", "Temperature: 0.2, Downfall: 0.3"),
            ('WINDSWEPT_HILLS', "Windswept Hills", "Temperature: 0.2, Downfall: 0.3"),
            ('WINDSWEPT_SAVANNA', "Windswept Savanna", "Temperature: 2.0, Downfall: 0.0"),
            ('WOODED_BADLANDS', "Wooded Badlands", "Temperature: 2.0, Downfall: 0.0"),
        ],
        default='PLAINS',
        update=on_material_setting_changed,
    )
